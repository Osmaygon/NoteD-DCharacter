...
- Munición opcional por usuario, visible/oculta según personaje, con bloques compactos: hasta 2 columnas en pantallas pequeñas y 3 desde pantallas medianas; solo son editables al crearlos o al pulsar `Editar`; en modo normal solo muestran contador con `+`/`-`.
